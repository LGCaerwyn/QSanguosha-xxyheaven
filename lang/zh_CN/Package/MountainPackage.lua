...
return {
	...
	["@qiaobian-2"] = "请选择有手牌的一至两名角色为目标",
	["@qiaobian-3"] = "请选择要交换牌的两个目标，第一个作为来源，第二个作为移动牌的目标",
	...
	["~qiaobianask2"] = "选择 1-2 名其他角色→点击确定",
	["~qiaobianask3"] = "选择两名角色→点击确定",
	...
	["zhiba_pindian_obtain"] = "是否获拼点牌",
	["zhiba_pindian_obtain:obtainPindianCards"] = "获得",
	...
	["zhijian"] = "直谏",
	[":zhijian"] = "出牌阶段，你可以将手牌中的一张装备牌置于一名其他角色的装备区里，然后摸一张牌。",
	["$PutEquip"] = "%from 将 %card 置入 %to 的装备区",
	["guzheng"] = "固政",
	[":guzheng"] = "其他角色的弃牌阶段结束时，你可以将弃牌堆里的一张该角色于此阶段内弃置过的其手牌交给该角色。若如此做，你可以获得弃牌堆里的所有于此阶段内因弃置而置入弃牌堆的牌。",
