...
return {
	...
	["hongyuan"] = "弘援",
	[":hongyuan"] = "摸牌阶段，你可以少摸一张牌。若如此做，摸牌阶段结束时，你令其他己方角色各摸一张牌。",
	[":hongyuan_p"] = "摸牌阶段，你可以少摸一张牌并选择至多两名其他角色。若如此做，摸牌阶段结束时，你令这些角色各摸一张牌。",
	["@hongyuan"] = "你可以发动“弘援”",
	["huanshi"] = "缓释",
	[":huanshi"] = "当己方角色的判定牌生效前，你可以打出一张牌代替之。",
	[":huanshi_p"] = "当一名角色的判定牌生效前，你可以令其观看你的手牌并选择你的一张牌。若如此做，你打出其选择的牌代替此判定牌。",
