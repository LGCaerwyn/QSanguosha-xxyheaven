...
return {
	...
	["spzhenwei"] = "镇卫",
	[":spzhenwei"] = "当一名其他角色成为【杀】或黑色锦囊牌的目标时(使用者不是你)，若该角色的体力值小于你且此牌的目标角色数为1，"..
	        "你可以弃置一张牌。若如此做，你选择一项：摸一张牌，然后将此【杀】或黑色锦囊牌转移给你；或令此【杀】或黑色锦囊牌无效，"..
			"然后将此【杀】或黑色锦囊牌置于使用者的武将牌旁，当前回合结束后，使用者获得其武将牌旁的这些牌。",
	["zhenweipile"] = "镇卫",
