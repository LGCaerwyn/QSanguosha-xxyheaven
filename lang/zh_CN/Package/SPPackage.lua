...
return {
	...
	["mozhi"] = "默识",
	[":mozhi"] = "结束阶段开始时，你可以将一张手牌当你本回合出牌阶段使用的第一张基本牌或非延时类锦囊牌使用。然后你可以将一张手牌当你本回合出牌阶段使用的第二张基本牌或非延时类锦囊牌使用。",
	...
	["zhenlve"] = "缜略",
	[":zhenlve"] = "锁定技，你使用的非延时类锦囊牌不能被无懈可击响应；你不能被选择为延时类锦囊的目标。",
	["jianshu"] = "间书",
	...
	--["designer:tadun"] = "",
	["luanzhan"] = "乱战",
	[":luanzhan"] = "你使用【杀】或黑色非延时类锦囊牌可以额外选择X名角色为目标；当你使用【杀】或黑色非延时类锦囊牌指定目标后，若此牌的目标角色数小于X，则X减至0（X为你拥有此技能时造成过伤害的次数）。",
	["@riot"] = "乱",
	...
	--["designer:caojie"] = "",
	["zuyin"] = "族荫",
	[":zuyin"] = "当你距离1以内的角色成为另一名其他角色使用【杀】或非延时类锦囊的目标后，你可亮出牌堆中的一张非基本牌，若亮出牌与此牌花色相同，此牌对该角色无效；若不同，你获得此牌。",
	["notbasic"] = "非基本牌",
	["tianzuo"] = "天祚",
