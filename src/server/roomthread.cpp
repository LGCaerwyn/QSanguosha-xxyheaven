...
DamageStruct::DamageStruct()
    ...
    transfer(false), by_user(true), reason(QString()), transfer_reason(QString()), transfer_from(QString())
{
}

DamageStruct::DamageStruct(const Card *card, ServerPlayer *from, ServerPlayer *to, int damage, DamageStruct::Nature nature)
    : chain(false), transfer(false), by_user(true), reason(QString()), transfer_reason(QString()), transfer_from(QString()), prevented(false)
{
    this->card = card;
    this->from = from;
    this->to = to;
...
DamageStruct::DamageStruct(const QString &reason, ServerPlayer *from, ServerPlayer *to, int damage, DamageStruct::Nature nature)
    : card(NULL), chain(false), transfer(false), by_user(true), transfer_reason(QString()), transfer_from(QString()), prevented(false)
{
    this->from = from;
    this->to = to;
    this->damage = damage;
